...
local Window = Fluent:CreateWindow({
    Title = "BLOX Hub",
    SubTitle = "Version 1:BY Rip_IndraKunn",
    TabWidth = 100,
    Size = UDim2.fromOffset(350, 530),
    Acrylic = true, -- The blur may be detectable, setting this to false disables blur entirely
    Image = "rbxassetid://72809668303340",
    Theme = "rbxassetid://72809668303340",
    MinimizeKey = Enum.KeyCode.End -- Used when theres no MinimizeKeybind
})
local Tabs = {
    Main = Window:AddTab({ Title = "Chế độ farm", Icon = "home" }),
    ...
    Shop = Window:AddTab({ Title = "Shop vật phẩm", Icon = "shopping-cart" }),
...
elseif local Fluent = loadstring(game:HttpGet("https://github.com/dawid-scripts/Fluent/releases/latest/download/main.lua"))()
local SaveManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/dawid-scripts/Fluent/master/Addons/SaveManager.lua"))()
local InterfaceManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/dawid-scripts/Fluent/master/Addons/InterfaceManager.lua"))()
--------------------------------------------------------------------------------------------------------------------------------------------
local Window = Fluent:CreateWindow({
